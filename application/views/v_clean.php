    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Clean Data</h3>
            </div>
        </div>
        ...
        <div class="col-lg-10">
            <div class="card-box">
                <div class="card-block">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo site_url("import/proses_clean") ?>" >
                        <input type="hidden" name="no" value=1>
                        <button type="submit" class="btn btn-primary">Clean Data Penjualan</button>
                    </form>
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo site_url("import/proses_clean") ?>" >
                        ...
                        <button type="submit" class="btn btn-danger">Clean Data Jurnal</button>
                    </form>
