        ...
        <td>
            ...
            <tr >
               ...
               <div style="font-size:20px;text-align:center;font-weight:bold;">
                ...
                <td width="400" rowspan="3" style="border:1px solid black;">
                    <table style="font-size: 14pt;vertical-align: top;">
                        <?
                            foreach ($get_asmed_ugd as $data ) {?>
                                ...
                                <tr>
                                    <td>Nama</td>
                                    <td>:</td>
                                    <td><?=$data->nm_pasien."   (".$data->jekel.")"?></td>
                                </tr>
                                <tr>
                                    <td>Umur</td>
                                    <td>:</td>
            ...
            <tr>
                <td style="border:1px solid black;text-align:center;" colspan="2">
                    <table>
                        <tr>
                            <td style="font-size:20pt;font-weight:bold;">PENILAIAN AWAL MEDIS GAWAT DARURAT</td>
                        </tr>
                    </table>
                </td>
            </tr>
