...
<table  padding="0">
          <tr>
            <td>No RM</td>
            <td >: </td>
            <td><?php  echo $get_pasien['no_rkm_medis'];?></td>
          </tr> 
          <tr>
            <td>Nama Pasien </td>
            <td width="5%">: </td>
            <td><?php  echo $get_pasien['nm_pasien'];?></td>
          </tr> 
          <tr>
            <td>JK/Umur</td>
            <td width="5%">: </td>
          ...
          <tr>
            <td>Alamat</td>
            <td >: </td>
            <td><?php  echo $get_pasien['no_rawat']." [".$get_pasien['status_lanjut']."]";?></td>
          </tr> 
          <tr>
            <td>No. Periksa </strong></p></td>
            <td>: </td>
            <td><?php  echo $get_pasien['png_jawab'];?></td>
          </tr> 
</table>
