    ...
    <tr>
        <td>
            ...
            <tr >
               ...
               <div style="font-size:15pt;text-align:center;font-weight:bold;">
                  No. <?=$get_spri->no_surat?>
                </div>
                <div style="font-size:14pt;text-align:center;">
                Tgl. <?=$get_spri->tgl_rencana?>
                </div>
   			    </td>
   			</tr>
            </table>
           ...
           <table width="100%"> 
            <tr>
                ...
                <td width="50%"><?=$get_spri->nm_dokter_bpjs?></td>
                <td> 
                <img src="<?php echo base_url(); ?>assets/Barcode.php?codetype=code128&size=50&text=<?=$get_spri->no_surat?>" alt="" width="200px">
                </td>
            </tr>
           </table>
        ...
        <table>
            ...
            <tr>
                <td>No. Kartu</td>
                <td>:</td>
                <td><?=$get_spri->no_kartu?></td>
            </tr>
            <tr>
                <td>Nama Pasien</td>
                <td>:</td>
                <td><?=$get_spri->nm_pasien." (".($get_spri->jk=="P" ? "PEREMPUAN" : "LAKI-LAKI").")"?></td>
            </tr>
            <tr>
                <td>Tgl. Lahir</td>
                <td>:</td>
                <td><?=$get_spri->tgl_lahir?></td>
            </tr>
            <tr>
                <td>Diagnosa Awal</td>
                <td>:</td>
                <td><?=$get_spri->nmdiagnosaawal?></td>
            </tr>
            <tr>
                <td>Tgl. Entri</td>
                <td>:</td>
                <td><?=$get_spri->tgl_surat?></td>
            </tr>
            <tr>
                <td><br></td>
                <td></td>
    ...
    <br>
        <table width="100%">
            <tr>
                ...
                <td style="font-size:8pt; width: 50%">Tgl. Cetak <?=date('d-m-Y',strtotime($get_spri->tgl_surat))." ".date('h:i:s');?></td>
