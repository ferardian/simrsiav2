                                        ...
                                        foreach ($pasien as $data ) {
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <br>
                                                    <a onclick='detail_status("<? echo str_replace("/","-",$data->no_rawat)?>")' ><button class="btn btn-sm btn-warning waves-effect waves-light" data-toggle="modal" data-target=".modal_status">Status</button></a> 
                                                    <?
                                                        if($get_status){
                                                    ...
                                                    <a onclick='ambil_klaim_inacbg("<? echo str_replace("/","-",$data->no_rawat)?>")' target="_blank"><button class="btn btn-sm btn-info waves-effect waves-light">Ambil Lembar Klaim (Inacbg)</button></a>
                                                    <br>
                                                    <br>
                                                    <a onclick='ambil_cppt("<? echo str_replace("/","-",$data->no_rawat)?>")' ><button class="btn btn-sm btn-secondary waves-effect waves-light" data-toggle="modal" data-target=".modal_cppt">CPPT</button></a> 
