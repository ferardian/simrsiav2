  ...
  <div class="row">
      <div class="col-xl-12">
          <div class="page-title-box">
              <h4 class="page-title float-left"><?php echo $nama; ?></h4>
...
<script>var link = "<?php
  if (strlen((string)$acc) ==4 ) {
    echo site_url().'bukban_data/getDataList1';
  } else if (strlen((string)$acc) ==2 ) {
    echo site_url().'bukban_data/getDataList2';
  } else {
    echo site_url().'bukban_data/getDataList3';
  }?>";</script>
...
function generateOrderTable(element){
    jQuery.ajax({
        ...
        url: link,
        data: {'nama_acc1' : element.nama_acc1 , 'nama_acc2' : element.nama_acc2 , 'nama_acc3' : element.nama_acc3 , 'tanggal' : element.tanggal, tgl:<?php echo $tgl ?>, acc:<?php echo $acc ?> },
        type: 'post',
        dataType: 'json',
        beforeSend: function () {
