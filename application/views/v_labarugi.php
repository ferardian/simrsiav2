                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                                ...
                                <td align="right"><?php echo $moneyFormat->rupiah($r->db1); ?></td>
                                <td align="right"><?php echo $moneyFormat->rupiah($r->db2); ?></td>
                                <td align="right"><?php
                                $total=0;
                                $total = $r->db1-$r->db2;
                                echo $moneyFormat->rupiah($total);
                                 ?></td>
                                 <td align="center">
                                   <a class="btn btn-success" role="button" href="<?php echo site_url("labarugi_data/index") ?>/<?php
                                 ...
                                 <td align="center">
                                   <a class="btn btn-warning" role="button" href="<?php echo site_url("labarugi_data/GroupByAkun") ?>/<?php


                                       $tgl = substr($r->tanggal,0,-5);
                                       $tahun = substr($r->tanggal,-4);
                                       if ($tgl == "Januari") {
                                         $time = 1;
                                         echo $time ;
                                       } else if ($tgl == "Februari") {
                                       ...
                                       ?>/<?php echo $tahun ?>">Detail Per Akun</a>
